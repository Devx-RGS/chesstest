    ...
    try {
        ...
        const newVideo = new Reel({
            ...
            interactive: {
                ...
                challengePrompt: videoData?.interactive?.challengePrompt || null,
        ...
        const updatedVideo = await Reel.findByIdAndUpdate(
            videoId,
            {
                $set: {
                    ...
                    "content.whitePlayer": updatedData?.content?.whitePlayer,
                    "content.blackPlayer": updatedData?.content?.blackPlayer,
                    ...
                    "interactive.challengePrompt": updatedData?.interactive?.challengePrompt,
                    ...
                    "interactive.timeLimit": updatedData?.interactive?.timeLimit,
