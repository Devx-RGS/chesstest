    ...
    >
      <SafeAreaView style={{ flex: 1, backgroundColor: '#0F0F23' }}>
        <ScrollView contentContainerStyle={{ padding: 20 }} showsVerticalScrollIndicator={false}>
          ...
          <Text style={{ color: '#A0A0B0', fontSize: 16, marginTop: 8, marginBottom: 24 }}>
          ...
          {timeControls.map((tc, idx) => (
            ...
            >
              <Text style={{ color: selected === idx ? '#fff' : '#00D9FF', fontSize: 18, fontWeight: 'bold', marginBottom: 4 }}>{tc.label}</Text>
              <Text style={{ color: '#A0A0B0', fontSize: 14 }}>{tc.description}</Text>
            </TouchableOpacity>
          ))}
          ...
          <View style={{ marginTop: 36 }}>
            ...
            <View style={{ gap: 12 }}>
              ...
              >
                ...
                <Text style={{ color: '#A0A0B0' }}>3:00 each, no increment; sequential pocket drops with 10s drop timer</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={{ backgroundColor: '#2C2F33', borderRadius: 12, padding: 16 }}
              ...
              >
                ...
                <Text style={{ color: '#A0A0B0' }}>3:00 each, no increment; queen decay timer (freezes when expired)</Text>
              </TouchableOpacity>
            </View>
          </View>
        </ScrollView>
