        ...
        (set) => ({
            ...
            loginUser: async (email: string, password: string) => {
                ...
                try {
                    const response = await axiosClient.post<{
                        ...
                        isAdmin: boolean;
                        token: string;
                        user: { _id?: string; id?: string; name?: string; username?: string; email: string };
            ...
            register: async (name: string, email: string, password: string) => {
                ...
                try {
                    ...
                    const user: User = {
                        id: userData._id || userData.id || "",
                        username: userData.username || userData.name || name,
                        email: userData.email,
                    };
            ...
            logout: () => {
                ...
                try {
                    const { queryClient } = require("../services/apiClient");
                    queryClient.clear();
                } catch (_e) { }
